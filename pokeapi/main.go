...
type PokemonStats struct {
	...
	Weight int `jsoPokemonStats:w http.ResponseWriter, r *http.Request`
}
...
func GetPokemonStats(url string) (PokemonStats, []byte, error) {
	res, err := http.Get(url)
	if err != nil {
		return PokemonStats{}, []byte{}, err
	}
	if res.StatusCode > 299 {
		return PokemonStats{}, []byte{}, errors.New("HTTP error")
	}
	...
	err = json.Unmarshal(rawData, &pokemonStats)
	if err != nil {
		return PokemonStats{}, []byte{}, err
	}

	return pokemonStats, rawData, nil
}
